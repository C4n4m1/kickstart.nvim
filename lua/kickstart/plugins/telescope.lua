return {
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      -- vim.keymap.set({ 'n', 'v' }, '<C-Space>',function() require'telescope.builtin'.buffers () end, { desc = '[S]earch existing [B]uffers' })
